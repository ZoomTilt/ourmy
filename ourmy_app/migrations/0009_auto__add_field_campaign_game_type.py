...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Campaign.game_type'
        db.add_column('ourmy_app_campaign', 'game_type',
                      self.gf('django.db.models.fields.CharField')(default='G', max_length=2),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Campaign.game_type'
        db.delete_column('ourmy_app_campaign', 'game_type')
    ...
    models = {
        ...
        'ourmy_app.action': {
            ...
            'end_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
            ...
            'start_at': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)', 'blank': 'True'}),
        ...
        'ourmy_app.campaign': {
            ...
            'deadline': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 20, 0, 0)', 'blank': 'True'}),
            'description': ('django.db.models.fields.TextField', [], {'max_length': '250', 'blank': 'True'}),
            'game_type': ('django.db.models.fields.CharField', [], {'default': "'G'", 'max_length': '2'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'logo_image': ('django.db.models.fields.files.FileField', [], {'max_length': '100', 'null': 'True', 'blank': 'True'}),
        ...
        'ourmy_app.campaignuser': {
            ...
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            'last_checked': ('django.db.models.fields.DateTimeField', [], {'default': 'datetime.datetime(2013, 2, 19, 0, 0)'}),
            'points_at_deadline': ('django.db.models.fields.IntegerField', [], {'default': '0'}),
            'user': ('django.db.models.fields.related.ForeignKey', [], {'to': "orm['auth.User']"})
        },
        'ourmy_app.prize': {
        ...
        'singly.singlyprofile': {
            ...
            'handle': ('django.db.models.fields.CharField', [], {'max_length': '260', 'null': 'True', 'blank': 'True'}),
            'id': ('django.db.models.fields.AutoField', [], {'primary_key': 'True'}),
            ...
            'thumbnail_url': ('django.db.models.fields.URLField', [], {'default': "''", 'max_length': '260', 'blank': 'True'}),
